...
//            nav.didMove(toParent: currentViewController)
    ...
    func pushToNextVC(identifier:String, isAnimate:Bool , currentViewController: UIViewController) {
        //varinder/5
        if identifier == "CampfireVC" {
            KAppDelegate.isGradiantShownForCampfire=false
        }
        
        //varinder/13
        if identifier == "WebSeriesVC" {
            KAppDelegate.isWebSeriesTabSelected=false
        }
    ...
    func logout(_ completion:@escaping() -> Void){
        WebServiceProxy.shared.getData("\(Apis.KServerUrl)\(Apis.KLogout)", showIndicator: true, completion: { (JSON) in
            ...
            if appResponse == 200 {
                ...
                UserDefaults.standard.set("", forKey: "InAppProduct_Id")
                UserDefaults.standard.synchronize()
                completion()
            }
        })
...
//            SwiftSpinner.hide()
    ...
    //varinder/12
    func Adspush(identifier:String ,weburl:String ) {
        ...
        if identifier.contains(" ://") {
            ...
            if identifier.contains("//canteen") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "CoinCanteenVC") as! CoinCanteenVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//home") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "GuestLandingPageVC") as! GuestLandingPageVC
                navv.comeFromAds = true
                vc?.navigationController?.pushViewController(navv, animated: true)
                
            }
            else   if identifier.contains("//about-us") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "aboutfromAds"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else    if identifier.contains("//camper-benefits") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "MemberBenefitsVC") as! MemberBenefitsVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//nearbycamp") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "NearMeCampsVC") as! NearMeCampsVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//live") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "HCLiveVC") as! HCLiveVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//web-series") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "WebSeriesVC") as! WebSeriesVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//360") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "360"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//ipadstore") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "HCShopifyHomeVC") as! HCShopifyHomeVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else if identifier.contains("//campfire") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "CampfireVC") as! CampfireVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else  if identifier.contains("//campstaff") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "CampStaff"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else   if identifier.contains("//community") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "Community"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//invite-friend") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "InviteAFriendVC") as! InviteAFriendVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//blog") {
                //   nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                let nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "HCStaticLinkVC") as! HCStaticLinkVC
                nav.str_URL = Apis.KBlog
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else   if identifier.contains("//faq's") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "FAQs"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//contact-us") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "ContactUs"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//join-team") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "JoinOurTeamVC") as! JoinOurTeamVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }
            else  if identifier.contains("//termServices") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "Terms & Conditions"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//policies") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "Privacy Policies"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else if identifier.contains("//disclaimer") {
                let navv = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "AboutUsVC") as! AboutUsVC
                navv.fromCont = "Disclaimer"
                vc?.navigationController?.pushViewController(navv, animated: true)
            }
            else  if identifier.contains("//castScreen") {
                nav = KAppDelegate.storyBoradVal.instantiateViewController(withIdentifier: "CastScreenVC") as! CastScreenVC
                vc?.navigationController?.pushViewController(nav, animated: true)
            }else{
                let svc = SFSafariViewController(url: NSURL(string: weburl)! as URL)
