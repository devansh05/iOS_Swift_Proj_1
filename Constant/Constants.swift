...
//  Created by Devansh on 3/10/18.
//  Copyright © 2018 Devansh. All rights reserved.
//
...
//Live
//    let KReceiptUrl             =   "https://buy.itunes.apple.com/verifyReceipt"

//enum Subscription {
//    static let secretIDKey            = "318513252bb941cb937e970329522e1c"
//
//    static let monthSubID             = "com.compax. .monthly"
//    static let quaterlySubID          = "com.compax. .quarterly"
//    static let yearlySubID            = "com.compax. .yearly"
//}

let monthSubID             = "com.compax. .monthly"
let quaterlySubID          = "com.compax. .quarterly"
let yearlySubID            = "com.compax. .yearly"
...
func bucketURL(server:String!) -> String! {
    ...
    if server == "http://34.195.246.195:3001/" {
        bucketURL = "https:// staging.s3.amazonaws.com"
    } else {
        bucketURL = "https://d32say8as79aym.cloudfront.net"
    }
    return bucketURL
}

//BUCKKET URL
//    static let bucketurl              =   "https:// live.s3.amazonaws.com"
//    static let bucketurl              =   "https:// staging.s3.amazonaws.com"  // Staging Bucket
...
//    static let KServerUrl             =  "https://devapi. live.com/"
    
    //STAGGING Site API
//    static let KSiteUrl             =     "https://dev. live.com/" //http://100.25.25.249/

    
    //    LIVE API
    ////   static let KServerUrl             =   "http://18.215.132.27:3001/"
            static let KServerUrl             =   "https://apis. live.com/"
    
    //    Live Site API
    ////    static let KSiteUrl             =   "http://18.215.132.27/"
            static let KSiteUrl             =   "https://www. live.com/"
    
    //    static let K360Camp               =   "http://54.147.2.187/"
    static let K360Camp               =   "https://virtual. live.com/ipad/"
    
    //    static let KBlog                  =   "http://34.202.241.63/?without=HF"
    static let KBlog                  =   "https://blog. live.com/?without=HF"
    ...
    static let KStore_Settings             =   "get_settings"
    ...
    static let KGetGoogleAddress      =   "https://maps.googleapis.com/maps/api/geocode/json"
       ...
       static let KShopifyBanner    =   "\(String(describing: bucketURL(server: KServerUrl)!))/shopify/"
    ...
    //static let KCampTestUrl         =   "https://s3.amazonaws.com/ live/testBucketfolder/"
    static let KCampTestUrl           =   "https://s3.amazonaws.com/ live/camps/campsbanner/"
}
