...
class EpisodesDetailsTVC: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    @IBOutlet weak var CollectionHeight_Constraints: NSLayoutConstraint!
...
//            collectionSetViewLayout()
    ...
    @objc func didTapOnAd(_ sender: UIButton) {
        ...
        delegate?.didselectAdvertisement(adUrl: advertisement.img_link_url, ad_device_Url :advertisement.img_link_url_device)
    }
...
//    }
    ...
    func colVwReload() {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
        let height = colVwEpisods.collectionViewLayout.collectionViewContentSize.height
        CollectionHeight_Constraints.constant = height
        self.layoutIfNeeded()
        }
    }
