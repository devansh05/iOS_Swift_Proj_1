...
//         let GuestLandingModelAryObj = GuestLandingModelAry[indexPath.row]
        ...
        SelectedVideoObj?.didSelected(selectedVideoId: VideoModelAryObj.videoId, videoUrl: VideoModelAryObj.videoUrl,videoindex: indexPath.item, catindex:collectionView.tag )
}
