...
class CamperStaffVC: UIViewController,TopHeaderViewDelegate,SelectMenuOption,SelectAviatorImage {
    ...
    //MARK:--> VARIABLE
    var camperStaffVMObj = CamperStaffVM()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let urlStr = Apis.KSiteUrl + "\(Apis.KCampStaffUrl)"
