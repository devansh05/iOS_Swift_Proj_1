...
public struct Product:Codable {
    ...
    //TODO: -Variants needs to add
    
    init(_id:String,_title:String,_desc:String,_price:String,_images:[JSON],_quantity:Int,_total_Price:String,_variantId:String) {
        id=_id
        title=_title
        desc = _desc
        images=_images
